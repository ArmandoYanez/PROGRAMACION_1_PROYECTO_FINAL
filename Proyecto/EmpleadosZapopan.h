...
#ifndef PROGRAMACION1_PROYECTOPARCIAL42_EMPLEADOSZAPOPAN_H
#define PROGRAMACION1_PROYECTOPARCIAL42_EMPLEADOSZAPOPAN_H
...
public:
    ...
    EmpleadoZAP(T Nombre, T2 Dia, T2 Mes, T2 Anio, T Cargo, T Direccion, T RFC, T2 NumeroDeCuenta,
...
class Jefe : public EmpleadoZAP<std::string, int> {
public:
    // Constructor implicito
    Jefe() : EmpleadoZAP<std::string, int>() {
    ...
    Jefe(std::string Nombre, int Dia, int Mes, int Anio, std::string Cargo, std::string Direccion,
         ...
         float Sueldo, std::string EstadoDePago):
            EmpleadoZAP<std::string, int>(Nombre, Dia,Mes, Anio, Cargo, Direccion,RFC, NumeroDeCuenta, NumeroDeSeguroSocial, Sueldo, EstadoDePago) {
    }

    // Se creo el metodo de creacion para la creacion de empleados comunes sin acceso a la plataforma.
    EmpleadoZAP<std::string, int> CreacionEmpleadoZAP(){
        EmpleadoZAP<std::string, int> EmpleadoNuevo;
...
#endif //PROGRAMACION1_PROYECTOPARCIAL42_EMPLEADOSZAPOPAN_H
